...
const changePrice = Number(inputPrice);
const changeDeliveryFee = Number(inputDeliveryFee);

const total = changePrice + changeDeliveryFee;
...
function getDeliveryTotal(total, deliveryFee) {
    return total + deliveryFee;
}

console.log('배송비 포함: ', getDeliveryTotal(getOrderTotal(3000, 2), 2500));